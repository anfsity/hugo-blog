...
![[Pasted image 20260113171505.png]]
...
![[Pasted image 20260112220704.png]]

这是 Evil 啊~（~~激动~~）。

ub 最可怕的不是“会崩”，而是编译器行为的未知：一旦某条路径触发 ub，优化器就可以把这条路径当作不存在，从而重排、删除你以为必要的逻辑。
